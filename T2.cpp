...
int main()
{
    ...
    vector<double> WartosciFunktora = { 3.0, 12.0, 5.5, 8.0, 15.0 };

    // Użycie funktora jako predykatu z algorytmem std::count_if
    int ZliczoneWartosci = count_if(WartosciFunktora.begin(), WartosciFunktora.end(), fun);

    // Wyświetlenie wyniku
    cout << "Liczba wartości w granicach zbioru: " << ZliczoneWartosci << endl;
}